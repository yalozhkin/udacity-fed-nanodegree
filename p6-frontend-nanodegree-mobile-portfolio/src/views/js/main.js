...
var resizePizzas = function(size) {
  ...
  function changePizzaSize(size) {
    ...
    // ****** OPTIMIZATION ******
    // Declare variables before the loop to avoid repeating declaration
    var
      newWidth,
      pizzaSize = document.querySelector("#pizzaSize"),
      randomPizzaContainer = document.querySelectorAll(".randomPizzaContainer");

    // ****** OPTIMIZATION ******
    // Define both slider label and pizza size on switch cases
    switch (size) {
      case "1":
        newWidth = 25;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // ****** OPTIMIZATION ******
  // Reduce number of pizzas. 200 was too many
  for (var i = 0; i < 32; i++) {
